...
public class DepositoController {
    ...
    public void realizarDeposito() {
        ...
        try {
            ...
            AlertaError.mostrar("Error", "El monto debe ser un número válido");
            return;
        }
        ...
        if (monto > 2000000) {
            AlertaError.mostrar("Error", "El monto máximo para un depósito es de $2.000.000.");
            return;
        }

        Sesion.guardarUsuario(cliente);

        boolean decision = AlertaConfirmacion.mostrar("¿Deseas Realizar el Depósito?", "Esta acción no se puede deshacer.");

        if (decision) {
            String resultado = cuentaService.realizarDeposito(cliente, monto);
            ...
            AlertaError.mostrar("Operación Cancelada", "No se realizó ningún depósito.");
        }
